...
import { useRoomBuilderDoors } from '~/composables/useRoomBuilderDoors';
import { useRoomBuilderTables } from '~/composables/useRoomBuilderTables';
import { useRoomBuilderWalls } from '~/composables/useRoomBuilderWalls';
import { useRoomBuilderZones } from '~/composables/useRoomBuilderZones';
...
const { addTable, addChair, removeTable, removeChair, flipTable, flipChair } = useRoomBuilderTables({
  tables: _tables,
  wallPoints,
  selectedTableIndex,
  selectedChairIndex,
...
const { addDoor, flipDoor, removeDoor } = useRoomBuilderDoors({
  doors: doors_,
  wallSegments,
  selectedDoorIndex,
  selectedTableIndex,
...
const { selectWall, resetWalls, performResetWalls } = useRoomBuilderWalls({
  wallPoints,
  wallStartPoint,
  wallPreviewPoint,
  wallClosed,
...
const { validateZone, confirmCreateZone, deleteZone, getZoneCenter } = useRoomBuilderZones({
  roomZonesData,
  currentZoneUnits,
  selectedZoneType,
  showZoneNamingModal,
